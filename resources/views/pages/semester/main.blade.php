<x-office-layout title="Data Semester">
    <div id="content_list">
                        ...
                        <div class="card-title">
                            <form id="content_filter">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="keyword" onkeyup="load_list(1);" class="form-control form-control-solid w-250px ps-14" placeholder="Cari Semester" />
                                </div>
                            </form>
                        </div>
                        <div class="card-toolbar">
                            <a href="javascript:;" onclick="load_input('{{route('office.semester.create')}}');" class="btn btn-primary">Tambah Semester</a>
                        </div>
                    </div>
