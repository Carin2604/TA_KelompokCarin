                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-10 fv-row">
                            <label class="required form-label">Tingkatan</label>
                            <input type="text" id="tingkatan" name="tingkatan" class="form-control mb-2" placeholder="tingkatan" value="{{ $data->tingkatan }}" />
                        </div>
                        <div class="mb-10 fv-row">
                            <label class="required form-label">Ruang</label>
                            <input type="text" id="ruang" name="ruang" class="form-control mb-2" placeholder="Ruang" value="{{ $data->ruang }}" />
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-end">
                    <a href="javascript:;" onclick="load_list(1);" class="btn btn-light me-5">Cancel</a>
                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{$data->id ? route('office.kelas.update',$data->id) : route('office.kelas.store')}}','{{$data->id ? 'PATCH' : 'POST'}}');" class="btn btn-primary">
